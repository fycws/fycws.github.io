...
// if (screen.width <= 400){
//     document.getElementById("nav-change-me").innerHTML = "";
//     console.log("UI Manager -> Re-builed the navigation bar as per the screen (Mobile sized x axis)");
// }
// else {
//     console.log("UI Manager -> Re-builed the navigation bar as per the screen (PC sized x axis)");
// }
